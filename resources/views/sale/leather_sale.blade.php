...
<div class="card-body">
    ...
    <div class="row card-category">
        ...
        <div class="col-md-6 text-right">
            <a href="/leather-sale-excel-csv-file/xlsx/Leather" class="btn btn-success btn-sm btn-rounded mb-2"><i class="fas fa-file mr-2"></i> Export Excel</a>
            <a href="/leather-sale-pdf" class="btn btn-danger btn-sm btn-rounded mb-2"><i class="fas fa-book mr-2"></i> Export PDF</a>
