...
<div class="card-body">
    ...
    <div class="row card-category">
        ...
        <div class="col-md-6 text-right">
            <a href="/purchase-excel-csv-file/xlsx" class="btn btn-success btn-sm btn-rounded mb-2"><i class="fas fa-file mr-2"></i> Export Excel</a>
            <a href="/purchase-pdf" class="btn btn-danger btn-sm btn-rounded mb-2"><i class="fas fa-book mr-2"></i> Export PDF</a>
            <a href="/purchase/create" class="btn btn-primary btn-sm btn-rounded mb-2"><i class="fas fa-plus mr-2"></i> Create</a>
        </div>
        @endif
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="/butcher/{{$dt->id}}/detail" class="btn btn-sm btn-rounded btn-secondary"><i class="fas fa-info"></i></a>
